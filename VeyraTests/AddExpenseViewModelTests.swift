...
final class AddExpenseViewModelTests: XCTestCase {
    ...
    func testEditPrefillsAndUpdatesExpense() {
        let expenseRepository = ViewModelExpenseRepository()
        let oldCategory = Veyra.Category(name: "Food", icon: "fork.knife", colorHex: "#5B7FFF")
        let newCategory = Veyra.Category(name: "Transport", icon: "car", colorHex: "#FF9500")
    ...
    private func makeViewModel(
        ...
        categories: [Veyra.Category] = [
            Veyra.Category(name: "Food", icon: "fork.knife", colorHex: "#5B7FFF")
        ],
