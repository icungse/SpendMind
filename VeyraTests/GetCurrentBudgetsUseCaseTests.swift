...
final class GetCurrentBudgetsUseCaseTests: XCTestCase {
    ...
    func testExecuteCalculatesCategoryBudgetFromMatchingExpensesOnly() async throws {
        let food = Veyra.Category(name: "Food", icon: "fork.knife", colorHex: "#FF7444")
        let transport = Veyra.Category(name: "Transport", icon: "car.fill", colorHex: "#576A8F")
    ...
    func testExecuteSortsByStatusThenTotalBudgetFirst() async throws {
        let category = Veyra.Category(name: "Food", icon: "fork.knife", colorHex: "#FF7444")
        let safeCategory = Veyra.Category(name: "Transport", icon: "car.fill", colorHex: "#576A8F")
